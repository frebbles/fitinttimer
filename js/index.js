...
var Stopwatch = function () {
    ...
    Stopwatch.prototype.print = function print() {
        ...
        // Additional code for colouring text based on time of minute (8 green, 12 orange)
        if ( ((this.times[1] >= 0) && (this.times[1] < 8)) || 
             ((this.times[1] >= 20) && (this.times[1] < 28)) ||
             ((this.times[1] >= 40) && (this.times[1] < 48)) )
        {      
          this.display.style.color = '#339933';
        }
        else {
          this.display.style.color = '#999933';
	}
